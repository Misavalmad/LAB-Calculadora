...
console.log('Suma de strings con function sumar 5 + 5 =', sumar('5', '5'))
console.log('Resta de strings 5 - 3 =', restar('5','3'))
console.log('Multiplicacion de strings 8 x 8 =', multiplicar('8', '8'));
console.log('Division de strings 15 / 3 =', dividir('15', '3'));
console.log('Division entre 0 con strings 5 / 0 =', dividir('5', '0'))